...
def str_(input_file):
    ...
    sigfile = input_file.replace(".txt", "___.pickle").replace("___", "_distmatrix").replace("TestMethods_txt","str")
    sigtimefile = "{}_sigtime.txt".format(input_file.replace(".txt","").replace("TestMethods_txt","str"))
